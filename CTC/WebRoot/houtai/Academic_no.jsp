									...
									<tbody>
										...
										<tr>
											...
											<button type="button" class="btn btn-info">查看详情</button>
												...
												<a onclick="return pass(<%=item.getAc_id()%>)">
...
<script type="text/javascript">
				...
				function pass(id){
					if(confirm("确定通过审核？")){
						window.location.href="houtai/addAcademic.jsp?ac_id="+id;
					}
				}
				function del(id){
					if(confirm("确定删除？")){
						window.location.href="houtai/deleteAcademic.jsp?ac_id="+id;
					}
				}
			</script>
