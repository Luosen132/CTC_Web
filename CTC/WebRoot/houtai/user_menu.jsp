									...
									<tbody>
										...
										<tr>
											...
											<td data-value="1" align="center">
												<a onclick="return paw(<%=item.getUNo()%>)" >
											    	<button type="button" class="btn btn-default">
												     <span class="entypo-pencil"></span>&nbsp;&nbsp;重置密码
												    </button>
												</a> &nbsp;&nbsp;&nbsp;
												
												<a onclick="return del(<%=item.getUNo()%>)" >
												<button type="button" class="btn btn-danger">
													<span class="entypo-cancel-squared"></span>&nbsp;&nbsp;封号
												</button> 
												</a>
...
<script type="text/javascript">
				function del(u_no){
					if(confirm("该用户即将关进小黑屋...")){
						window.location.href="houtai/stopUser.jsp?u_no="+u_no;
					}
				}
			</script>
			...
			<script type="text/javascript">
				function paw(id){
					if(confirm("即将重置该用户的密码...")){
						window.location.href="houtai/modifyPwd.jsp?u_no="+id;
					}
				}
			</script>
